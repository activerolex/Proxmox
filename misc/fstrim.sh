...
whiptail --backtitle "Proxmox VE" --title "Proxmox VE LXC Filesystem Trim" --yesno "The LXC containers will undergo the fstrim command. Proceed?" 10 58 || exit
NODE=$(hostname)
EXCLUDE_MENU=()
MSG_MAX_LENGTH=0
...
excluded_containers=$(whiptail --backtitle "Proxmox VE" --title "Containers on $NODE" --checklist "\nSelect containers to skip from trimming:\n" \
