#!/usr/bin/env bash
source <(curl -s https://raw.githubusercontent.com/activerolex/Proxmox/main/misc/build.func)
...
function update_script() {
  ...
  while true; do
    CHOICE=$(whiptail --backtitle "Proxmox VE" --title "SUPPORT" --radiolist --cancel-button Exit-Script "Spacebar = Select"  11 58 3 \
